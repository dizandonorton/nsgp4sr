function [v,b]=test_novelty(infile, gen, pop, fit)	
%
%
%
%
...
tmp_x_training = 'tmp_x_training2.txt';
tmp_y_training = 'tmp_y_training2.txt';
tmp_x_test = 'tmp_x_test2.txt';
tmp_y_test = 'tmp_y_test2.txt';
