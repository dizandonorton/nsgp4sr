...
if start
   ...
   if isempty(strfind(filenamex,filesep))
   ...
   if isempty(strfind(filenamey,filesep))
      % if file was not given with path, use parentdir (where this file is):
   ...
   if params.usetestdata
      ...
      if isempty(strfind(testfilenamex,filesep))
      ...
      if isempty(strfind(testfilenamey,filesep))
