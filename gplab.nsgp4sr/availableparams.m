...
myparams.calcfitness={'regfitness','antfitness','antfitness_lib', 'RMSE','pcc','linearscaling', 'MAE', 'MASE', 'RMSLE', 'rsquared', 'noveltysearch'};
...
defaults.functions='{''plus'' 2; ''minus'' 2; ''times'' 2; ''mydivide'' 2}';
defaults.terminals='{}';
